...
CATALOGUE: tuple[CelestialBody, ...] = (
    CelestialBody(
        "the Distant Wanderer", PLANET, magnitude=8.5, period=30, offset=0, window=15,
        lore="a dim blue-green speck creeping along the edge of sight",
    ),
    CelestialBody(
        "the Long-Tailed Visitor", COMET, magnitude=7.0, period=40, offset=0, window=3,
        lore="a smear of light dragging a ghostly tail",
    ),
    CelestialBody(
        "the Morning Lantern", PLANET, magnitude=-1.5, period=8, offset=0, window=5,
        lore="a brilliant point that leads the coming dawn",
    ),
    CelestialBody(
        "the Pale Wayfarer", COMET, magnitude=10.5, period=64, offset=0, window=2,
        lore="a barely-there haze that returns only on the long count",
    ),
    CelestialBody(
        "the Red Wanderer", PLANET, magnitude=1.0, period=12, offset=0, window=8,
        lore="a ruddy light that drifts slowly against the fixed stars",
    ),
    CelestialBody(
        "the Ringed Wanderer", PLANET, magnitude=5.5, period=20, offset=0, window=12,
